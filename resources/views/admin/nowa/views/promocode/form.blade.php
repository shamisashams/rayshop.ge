            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="discount" value="{{$model->discount}}">
                        @error('discount')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="promocode" value="{{$model->promocode ? $model->promocode : $promocode}}">
                        @error('promocode')
                        <small class="text-danger">
                            <div class="error">
                                {{$message}}
